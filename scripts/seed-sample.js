  ...
  try {
    ...
    const episodes = [
      ...
      },
      {
        ...
        description:
          "Master CSS to create beautiful and responsive web layouts.",
        videoUrl:
    ...
    for (const episodeData of episodes) {
      ...
      console.log("Episode created:", episode.title);
    }

    console.log("Sample data created successfully!");
    console.log(`Visit: http://localhost:3000/courses/${course.slug}`);
  } catch (error) {
